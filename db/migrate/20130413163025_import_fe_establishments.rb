require 'csv'
class ImportFeEstablishments < ActiveRecord::Migration
  def up
    columns_array = [2, 9, 10, 7, 8, 5, 3, 11, 6, 0]  

    csv = CSV.read("/users/Azymuth/Documents/Work/TechCube/LJDataJam/Datasets/Cleaning/scotxed/fe_centres_ll_formatted.csv")
    csv.each do |row|
    e = Establishment.new
